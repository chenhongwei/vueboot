<template>
  <div v-if="show && ready" class="row align-items-center no-gutters">
    <div class="col">
      <ul class="pagination">
    ...
    <div class="col d-flex flex-row-reverse">
      <nav aria-label="pagination">
        <ul class="pagination">
          ...
          <li class="page-item" v-if="page - maxPages >= 1" @click="page - maxPages >= 1 && setPage(page - maxPages)">
          ...
          <li class="page-item" v-if="page + maxPages < max" @click="page + maxPages < max && setPage(page + maxPages)">
            <a class="page-link pointer" aria-label="Next">
              <span aria-hidden="true">...</span>
              <span class="sr-only">...</span>
            </a>
...
export default {
  ...
  props: {
    ...
    smallCountText: {
      type: String,
      required: false,
      default: '{from}-{to} / {count}|{count} records|One record'
    }
  },
  data () {
    return {
